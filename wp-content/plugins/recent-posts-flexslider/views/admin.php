...
<p>
    ...
    <input style="width: 60px;" id="<?php echo $this->get_field_id('slider_duration'); ?>" name="<?php echo $this->get_field_name('slider_duration'); ?>" value="<?php echo $instance['slider_duration']; ?>" type="text" />
</p>
...
<p>
    ...
    <input style="width: 60px;" id="<?php echo $this->get_field_id('slider_pause'); ?>" name="<?php echo $this->get_field_name('slider_pause'); ?>" value="<?php echo $instance['slider_pause']; ?>" type="text" />
</p>

<p>
    <label for="<?php echo $this->get_field_id('slider_count'); ?>"><?php _e( 'Number of slides to display', 'recent-post-flexslider-locale' ) ?></label>
    <input style="width: 60px;" id="<?php echo $this->get_field_id('slider_count'); ?>" name="<?php echo $this->get_field_name('slider_count'); ?>" value="<?php echo $instance['slider_count']; ?>" type="text" />
</p>
...
<p>
    ...
    <input style="width: 60px;" id="<?php echo $this->get_field_id('slider_height'); ?>" name="<?php echo $this->get_field_name('slider_height'); ?>" value="<?php echo $instance['slider_height']; ?>" type="text" />
</p>
...
<p>
    ...
    <input style="width: 60px;" id="<?php echo $this->get_field_id('excerpt_length'); ?>" name="<?php echo $this->get_field_name('excerpt_length'); ?>" value="<?php echo $instance['excerpt_length']; ?>" type="text" />
</p>
